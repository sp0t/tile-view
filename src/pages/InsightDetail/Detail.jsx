      ...
      >
        <article className="post-14502 insights type-insights status-publish format-standard has-post-thumbnail hentry topic-market-structure region-asia-pac">
          <header>
            ...
            <div className="top">
              Market structure &nbsp;<span className="bold">·</span>&nbsp;{" "}
              <time
              ...
              <div className="optiver-series">
                ...
                <ul>
                  <li>
                    <a
                      className
                      href="/insights/how-to-bring-apacs-equity-options-markets-to-life/"
          ...
          <section>
            <p>
              <em>
                ...
                <a href="/insights/how-to-bring-apacs-equity-options-markets-to-life/">
                  click here
                </a>
                .<br />
              </em>
            ...
            <figure className="wp-block-image size-large is-style-rounded">
              <img
                ...
                width={768}
                height={402}
                src="https://optiver.com/wp-content/uploads/2023/07/Shrinking-spreads_1200x628-768x402.png"
            ...
            <div className="wp-block-buttons">
              <a
                href="https://share.hsforms.com/1XnKyKxenThuigIKKAXsDSQ4xtvs"
                className="btn wp-block-button"
                target="_blank"
                rel="noopener"
              >
            ...
            <div className="wp-block-buttons">
              <a
                href="../../wp-content/uploads/2023/07/Optiver_Insights_APAC_SSO_Article3.pdf"
                className="btn"
              >
